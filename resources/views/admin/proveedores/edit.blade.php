    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div>
            <a href="{{ route('admin.proveedores.create') }}"
                class="btn btn-green text-white font-bold py-2 px-4 rounded text-xs">Nuevo Proveedor</a>
            <a href="{{ route('admin.proveedores.index') }}"
                class="btn btn-green-dark text-white font-bold py-2 px-4 rounded text-xs">Listado de Proveedores</a>
        </div>
    </div>
