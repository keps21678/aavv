    ...
    <div class="flex items-center justify-between">
        ...
        <div>
            <a href="{{ route('admin.incidencias.create') }}"
                class="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-xs">Nueva incidencia</a>
            <a href="{{ route('admin.socios.index') }}"
                class="btn btn-green-dark text-white font-bold py-2 px-4 rounded text-xs">Listado de Socios/as</a>
            </div>
    </div>
    <br />
